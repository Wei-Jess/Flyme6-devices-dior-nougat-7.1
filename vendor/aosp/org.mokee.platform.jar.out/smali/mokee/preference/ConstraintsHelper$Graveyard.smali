.class Lmokee/preference/ConstraintsHelper$Graveyard;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lmokee/preference/ConstraintsHelper;
.end annotation
...
# static fields
.field private static sInstance:Lmokee/preference/ConstraintsHelper$Graveyard;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lmokee/preference/ConstraintsHelper$Graveyard;->mDeathRow:Ljava/util/Set;

    .line 335
    iput-object p1, p0, Lmokee/preference/ConstraintsHelper$Graveyard;->mContext:Landroid/content/Context;

    .line 334
    return-void
.end method

.method public static declared-synchronized get(Landroid/content/Context;)Lmokee/preference/ConstraintsHelper$Graveyard;
    .locals 2
    .param p0, "context"    # Landroid/content/Context;

    .prologue
    const-class v1, Lmokee/preference/ConstraintsHelper$Graveyard;

    monitor-enter v1

    .line 339
    :try_start_0
    sget-object v0, Lmokee/preference/ConstraintsHelper$Graveyard;->sInstance:Lmokee/preference/ConstraintsHelper$Graveyard;

    if-nez v0, :cond_0

    .line 340
    new-instance v0, Lmokee/preference/ConstraintsHelper$Graveyard;

    invoke-direct {v0, p0}, Lmokee/preference/ConstraintsHelper$Graveyard;-><init>(Landroid/content/Context;)V

    sput-object v0, Lmokee/preference/ConstraintsHelper$Graveyard;->sInstance:Lmokee/preference/ConstraintsHelper$Graveyard;
...
.method private getParent(Landroid/support/v7/preference/Preference;Landroid/support/v7/preference/Preference;)Landroid/support/v7/preference/PreferenceGroup;
    ...
    invoke-direct {p0, v0, p2}, Lmokee/preference/ConstraintsHelper$Graveyard;->getParent(Landroid/support/v7/preference/PreferenceGroup;Landroid/support/v7/preference/Preference;)Landroid/support/v7/preference/PreferenceGroup;
...
.method private getParent(Landroid/support/v7/preference/PreferenceGroup;Landroid/support/v7/preference/Preference;)Landroid/support/v7/preference/PreferenceGroup;
    ...
    invoke-direct {p0, v1, p2}, Lmokee/preference/ConstraintsHelper$Graveyard;->getParent(Landroid/support/v7/preference/PreferenceGroup;Landroid/support/v7/preference/Preference;)Landroid/support/v7/preference/PreferenceGroup;
...
.method private removePreference(Landroid/support/v7/preference/PreferenceManager;Landroid/support/v7/preference/Preference;)V
    ...
    .prologue
    .line 370
    invoke-direct {p0, p2, p2}, Lmokee/preference/ConstraintsHelper$Graveyard;->getParent(Landroid/support/v7/preference/Preference;Landroid/support/v7/preference/Preference;)Landroid/support/v7/preference/PreferenceGroup;
    ...
    .line 373
    invoke-direct {p0, p2, v0}, Lmokee/preference/ConstraintsHelper$Graveyard;->getParent(Landroid/support/v7/preference/Preference;Landroid/support/v7/preference/Preference;)Landroid/support/v7/preference/PreferenceGroup;
...
.method public addTombstone(Ljava/lang/String;)V
    ...
    .prologue
    .line 346
    iget-object v1, p0, Lmokee/preference/ConstraintsHelper$Graveyard;->mDeathRow:Ljava/util/Set;

    monitor-enter v1

    .line 347
    :try_start_0
    iget-object v0, p0, Lmokee/preference/ConstraintsHelper$Graveyard;->mDeathRow:Ljava/util/Set;
...
.method public summonReaper(Landroid/support/v7/preference/PreferenceManager;)V
    ...
    .prologue
    .line 378
    iget-object v4, p0, Lmokee/preference/ConstraintsHelper$Graveyard;->mDeathRow:Ljava/util/Set;

    monitor-enter v4

    .line 379
    :try_start_0
    iget-object v3, p0, Lmokee/preference/ConstraintsHelper$Graveyard;->mDeathRow:Ljava/util/Set;
    ...
    .line 382
    invoke-direct {p0, p1, v2}, Lmokee/preference/ConstraintsHelper$Graveyard;->removePreference(Landroid/support/v7/preference/PreferenceManager;Landroid/support/v7/preference/Preference;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
