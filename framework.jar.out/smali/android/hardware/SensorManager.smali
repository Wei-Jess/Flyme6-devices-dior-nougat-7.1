...
.method public getDefaultSensor(I)Landroid/hardware/Sensor;
    ...
    const-string/jumbo v6, "ro.mk.device"
    ...
    .local v4, "sensor$iterator":Ljava/util/Iterator;
    :cond_3
    :goto_1
    ...
    .end local v4    # "sensor$iterator":Ljava/util/Iterator;
    :cond_4
    const/16 v6, 0x16
    ...
    .restart local v4    # "sensor$iterator":Ljava/util/Iterator;
    :cond_5
    if-ne p1, v8, :cond_3
